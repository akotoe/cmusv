...
class PeopleController < ApplicationController
  ...
  before_filter :authenticate_user!, :except => [:show_by_twiki, :new_user, :update]
...
#
  ...
  # GET /people/new_user/random_token
  ...
  def new_user
    ...
    if @person && !@person.active_directory_account_created_at.nil?
      redirect_to root_url, :flash => { :error => "Account creation link has expired. Please contact help@sv.cmu.edu" } and return
    end
  ...
  def update
    ...
    respond_to do |format|
      ...
      if @person.save
        ...
        if active_directory_account_operation == "create_account" || (active_directory_account_operation.nil? && @person.active_directory_account_created_at.nil?)
