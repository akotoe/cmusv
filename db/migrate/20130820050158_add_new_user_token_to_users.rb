class AddNewUserTokenToUsers < ActiveRecord::Migration
  def self.up
    ...
    #add_column :users, :new_user_token_sent_at, :datetime
    #add_column :users, :password_reset_token, :string
    #add_column :users, :password_reset_sent_at, :datetime
    #add_column :user_versions, :new_user_token, :string
    add_column :user_versions, :new_user_token_sent_at, :string
  ...
  def self.down
    ...
    remove_column :user_versions, :new_user_token_sent_at
